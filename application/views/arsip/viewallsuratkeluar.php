					...
					<div class="col-md-4">
						<table width="100%" class="table table-sm">
							...
							<tr>
								<td>Tgl Surat</td>
								<td>:</td>
								<td><b><?= date('d/m/Y', $iz['dibuat_pada']); ?><b></td>
							</tr>
							<tr>
								<td>Perihal</td>
								<td>:</td>
						...
						<table width="100%" border="0" style="text-align:center">
							...
							<tr>
								<td>
									<div class="my-2"></div>
									<a href="<?= base_url('arsip/suratkeluar'); ?>" class="btn btn-success btn-icon-split">
						...
						<div class="card-body">
							<table>
								...
								<?php if ($iz['berkas_surat'] == "") : ?>
									...
									<?php else : ?>
									<tr>
										<td><img src="<?= base_url('assets/img/surat_keluar/'); ?><?= $iz['berkas_surat']; ?>" width="100%"></td>
									<?php endif; ?>
									</tr>
